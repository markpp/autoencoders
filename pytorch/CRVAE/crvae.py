...
class CRVAE(object):
    ...
    def calculate_loss(self, model, original_samples, augmented_samples):
        mu, logvar, recon, z = model(original_samples)
        mu_aug, logvar_aug, recon_aug, z_aug = model(augmented_samples)
        ...
        loss = cr_vae_loss + vae_loss + aug_vae_loss
