...
if __name__ == "__main__":
    ...
    if not os.path.exists(output_dir):
        os.mkdir(output_dir)
    torch.save(model, os.path.join(output_dir,"model_cifar10.pt"))
    torch.save(model.encoder, os.path.join(output_dir,"encoder_cifar10.pt"))
    torch.save(model.decoder, os.path.join(output_dir,"decoder_cifar10.pt"))
