...
dataset_source = 'nozzle'

# Data paths. Not used for (binarized_mnist, cifar-10)
train_data_path = '/home/aau3090/Datasets/nozzle_dataset/spray_frames/generative/train_sample'
val_data_path = '/home/aau3090/Datasets/nozzle_dataset/spray_frames/generative/val_sample'
synthesis_data_path = '/home/aau3090/Datasets/nozzle_dataset/spray_frames/generative/val_sample'
...
up_strides = [1] * 5 + [2] + [1] * 12 + [2] + [1] * 12 + [2] + [1] * 11 + [2] + [1] * 7 + [2] + [1] * 4 + [2] + [1] * 3 + [4] + [1] * 2
# Defines the number of residual blocks prior to a connection with top-down
up_n_blocks_per_res =  [0] * 5 + [0] + [0] * 12 + [0] + [0] * 12 + [0] + [0] * 11 + [0] + [0] * 7 + [0] + [1] + [0] * 3 + [0] + [2] + [0] * 2 + [0] + [2] + [0]
...
down_strides = [1] * 2 + [4] + [1] * 3 + [2] + [1] * 4 + [2] + [1] * 7 + [2] + [1] * 11 + [2] + [1] * 12 + [2] + [1] * 12 + [2] + [1] * 5
...
down_n_blocks_per_res = [0] * 2 + [0] + [0] * 3 + [0] + [0] * 4 + [2] + [0] * 7 + [4] + [0] * 11 + [0] + [0] * 12 + [0] + [0] * 12 + [0] + [0] * 5
...
down_filters = [512] * 19 + [256] * 12 + [128] * 13 + [64] * 13 + [32] * 6
# Defines the bottleneck ratio inside the bottleneck res block
down_mid_filters_ratio = [0.25] * 19 + [0.25] * 12 + [0.25] * 13 + [0.5] * 13 + [1.] * 6
# Defines the kernel size of the convs of the res block
down_kernel_size = [1] * 2 + [3] * 61
# Defines the number of gaussian variates per top-down block
down_latent_variates = [64] * 63
...
checkpoint_and_eval_interval_in_steps = 2500
...
synthesis_batch_size = val_batch_size