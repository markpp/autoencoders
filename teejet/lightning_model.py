...
class LightningAutoencoder(pl.LightningModule):
    ...
    def prepare_data(self):
        ...
        self.data_val = prepare_data_from_list(self.exp_parms['val_list'])

    def train_dataloader(self):
        self.num_train_imgs = len(self.data_train)
        return standard_dataloader(self.data_train, batch_size=self.exp_parms['batch_size'], num_workers=self.trainer_parms['n_workers'])
